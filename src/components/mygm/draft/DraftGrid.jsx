        ...
        return (
          <div key={wrestler.id} className={`wrestler-card ${(!canAfford || !isPlayerTurn) ? 'cannot-afford' : ''}`}>
            <div className="wrestler-image-container">
              ...
              <span className={`alignment-badge ${wrestler.default_alignment.toLowerCase()}`}>{t(`align_${wrestler.default_alignment.toLowerCase()}`)}</span>
            </div>
            <div className="wrestler-info">
              ...
              <div className="stats-row">
                ...
                <div className="meta-info">
                  ...
                  <span className="style-tag">{t(`style_${wrestler.style.toLowerCase()}`)}</span>
                </div>
              </div>
